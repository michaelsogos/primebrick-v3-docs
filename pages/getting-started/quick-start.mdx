...
```bash
git clone https://github.com/michaelsogos/primebrick-v3-backend.git
git clone https://github.com/michaelsogos/primebrick-v3-frontend.git
```

If you plan to develop microservices or shared libraries, also clone:

```bash
git clone https://github.com/michaelsogos/primebrick-v3-microservices.git   # microservices
git clone https://github.com/michaelsogos/primebrick-v3-dal.git  # DAL library
